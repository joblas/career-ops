...
- Report bugs via [Issues](https://github.com/joblas/career-ops/issues)
...
- [Open an issue](https://github.com/joblas/career-ops/issues)
- [Read the architecture docs](docs/ARCHITECTURE.md)
- Forked by [Joseph Blas](https://joestechsolutions.com). Originally built by [santifer](https://santifer.io).
