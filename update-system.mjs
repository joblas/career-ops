...
const CANONICAL_REPO = 'https://github.com/joblas/career-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/joblas/career-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/joblas/career-ops/releases/latest';
