...
|-----------|---------------|---------------|
| **AI Developer / ML Engineer** | LLM integration, RAG, agents, model deployment, API design | Someone who builds and ships AI-powered features end-to-end |
| **DevOps / SRE** | CI/CD, infrastructure, reliability, monitoring, automation | Someone who keeps systems running and deploys with confidence |
| **Embedded Systems / Robotics Engineer** | Firmware, real-time, sensors, hardware-software integration | Someone who bridges hardware and software for physical systems |
| **Automation / QA Engineer** | Test automation, frameworks, tooling, pipeline quality | Someone who builds automated test systems and ensures quality |
| **Full-Stack Developer** | Frontend, backend, APIs, databases, cloud deployment | Someone who can own a feature from UI to infrastructure |
| **IT Systems / Infrastructure** | Networking, sysadmin, cloud, security, troubleshooting | Someone who manages and scales enterprise IT environments |
...
|-------------------|--------------------------|--------------------------|
| AI Developer / ML Engineer | Builder of AI-powered systems, LLM integration, RAG pipelines, agent orchestration | article-digest.md + cv.md |
| DevOps / SRE | Infrastructure automation, CI/CD pipelines, monitoring, reliability | cv.md + article-digest.md |
| Embedded / Robotics | Hardware-software integration, real-time systems, sensor fusion, AV experience | cv.md + article-digest.md |
| Automation / QA | Test framework design, automation pipelines, quality systems | cv.md + article-digest.md |
| Full-Stack Developer | End-to-end feature delivery, API design, frontend + backend | cv.md + article-digest.md |
| IT Systems / Infrastructure | System administration, networking, cloud ops, troubleshooting | cv.md + article-digest.md |

**Cross-cutting advantage**: Frame profile as **"Hands-on builder"** who adapts framing to the role:
- For AI: "builder who ships AI features from prototype to production with real-world deployment experience"
- For DevOps: "builder who automates infrastructure and ensures reliability with monitoring and CI/CD"
- For Embedded: "builder with deep AV industry experience bridging hardware and software"
- For QA: "builder who designs automated test systems and quality pipelines"
- For Full-Stack: "builder who owns features end-to-end from UI to backend to deployment"
- For IT Systems: "builder who manages and scales infrastructure with hands-on troubleshooting experience"
...
- AI Developer → prioritize LLM integration, RAG, agent building, model deployment
- DevOps → prioritize CI/CD, infrastructure automation, monitoring
- Embedded → prioritize hardware-software integration, real-time, AV experience
- QA → prioritize test automation, frameworks, quality pipelines
- Full-Stack → prioritize end-to-end delivery, APIs, frontend + backend
- IT Systems → prioritize sysadmin, networking, cloud ops
...
2. **"Sell up without lying" plan**: specific phrases, concrete achievements, self-taught and AV experience as an advantage
